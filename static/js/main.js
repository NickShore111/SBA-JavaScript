...
const domElements = {
  collectDOM: function () {
    this.deppTable = document.getElementById("depp-table");
    this.heardTable = document.getElementById("heard-table");
    this.aboutDepp = document.getElementById("about-depp");
    this.aboutHeard = document.getElementById("about-heard");
  },
};
